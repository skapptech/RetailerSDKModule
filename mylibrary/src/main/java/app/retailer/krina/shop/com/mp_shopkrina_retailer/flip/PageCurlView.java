...
public class PageCurlView extends View {
     ...
     * Initialize the view
     */
    private void init(Context context, ArrayList<Bitmap> mPages) {
    ...
    public void ResetClipEdge() {
        ...
        // Now set the points
        // those points MUST come from our measures and
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        // Only consume event if we need to.
        return true;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // This just scales the views to the current
