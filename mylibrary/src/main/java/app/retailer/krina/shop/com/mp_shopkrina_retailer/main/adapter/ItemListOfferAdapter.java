...
public class ItemListOfferAdapter extends RecyclerView.Adapter<ItemListOfferAdapter.ViewHolder> implements OnItemClick, MoqInterface {
    ...
    public ItemListOfferAdapter(HomeActivity activity, List<ItemListModel> list) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, int i) {
        ...
        viewHolder.mBinding.tvMultiMoq.setOnClickListener(v -> {
            BottomSheetDialog dialog = new BottomSheetDialog(activity, R.style.Theme_Design_BottomSheetDialog);
    ...
    private void setValueInUI(@NonNull ViewHolder viewHolder, ItemListModel model) {
        ...
        try {
            ...
            if (model.isOffer) {
                ...
                viewHolder.mBinding.liOfferView.setVisibility(View.VISIBLE);
                viewHolder.mBinding.llFlashOfferView.setVisibility(View.GONE);
                ...
                if (model.getOfferType() != null) {
                    switch (model.getOfferType()) {
                        ...
                        case "FlashDeal":
                            ...
                            if (!isflashDealUsed) {
                                viewHolder.mBinding.tvLeftItems.setText(String.valueOf(model.getOfferQtyAvaiable()));
                                viewHolder.mBinding.liOfferView.setVisibility(View.GONE);
                                viewHolder.mBinding.llFlashOfferView.setVisibility(View.VISIBLE);
                ...
                viewHolder.mBinding.tvGetValue.setText(Html.fromHtml(freeOfferTextGet));
            ...
            if (cartModel != null && model.getItemId() == cartModel.getItemId()) {
                ...
                if (cartModel.isOffer) {
                    if (cartModel.getOfferType().equalsIgnoreCase("WalletPoint")) {
                        ...
                        if (remainingLeft > 0) {
                            viewHolder.mBinding.tvLeftItems.setText("" + remainingLeft);
                        } else {
                            viewHolder.mBinding.tvLeftItems.setText("0");
                        }
                    }
                }
                // offer section end
    ...
    private void itemAddRemove(@NonNull ViewHolder viewHolder, ItemListModel model, boolean addItem, boolean addBtn) {
        ...
        try {
            if (new Utils(activity).isNetworkAvailable()) {
                ...
                // get item limit
                int itemQuantity = Integer.parseInt(viewHolder.mBinding.tvSelectedItemQuantity.getText().toString());
...
//            }
    ...
    // mow click
    @Override
    public void onSelect(ItemListModel model, int pos) {
