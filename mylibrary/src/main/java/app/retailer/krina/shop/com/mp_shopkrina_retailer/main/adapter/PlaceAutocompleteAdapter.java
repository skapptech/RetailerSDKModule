...
public class PlaceAutocompleteAdapter extends ArrayAdapter<PlaceAutocompleteAdapter.PlaceAutocomplete> implements Filterable {
     ...
     * successfully.
     * This method MUST be called off the activity_home UI thread, as it will block until data is returned
    ...
    private ArrayList<PlaceAutocomplete> getAutocomplete(CharSequence constraint) {
        if (mGoogleApiClient.isConnected()) {
            ...
            // This method should have been called off the activity_home UI thread. Block and wait for at most 60s
...
//
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        try {
            ...
            tvPlaceDescription = convertView.findViewById(R.id.tv_google_suggestions);
