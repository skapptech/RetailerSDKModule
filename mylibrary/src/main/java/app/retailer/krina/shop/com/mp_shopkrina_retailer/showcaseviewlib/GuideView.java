package app.retailer.krina.shop.com.mp_shopkrina_retailer.showcaseviewlib;
...
public class GuideView extends FrameLayout {
    ...
    protected void onDraw(final Canvas canvas) {
        ...
        if (target != null) {
            ...
            int padding = 50;
            rect = new Rect(canvas.getWidth() + 500, canvas.getHeight() - padding, padding, padding);
            paint.setColor(white);
            paint.setTextSize(60);
            //paint.setTypeface(Typeface.create("Arial",Typeface.NORMAL));
            paint.setTypeface(ResourcesCompat.getFont(context, R.font.avalon_demi));
            canvas.drawText("Skip", canvas.getWidth() - 210, canvas.getHeight() - 210, paint);
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            if (b >= getHeight() - 400 && a >= getWidth() - 400) {
                //if (b>getHeight()/1.5&& b>getWidth()/1.5) {
                ((ViewGroup) ((Activity) getContext()).getWindow().getDecorView()).removeView(this);
                if (!StoryBordSharePrefs.getInstance(getContext()).getBoolean(StoryBordSharePrefs.HOMEPAGE)) {
                    StoryBordSharePrefs.getInstance(getContext()).putBoolean(StoryBordSharePrefs.HOMEPAGE, true);
                }
                if (!StoryBordSharePrefs.getInstance(getContext()).getBoolean(StoryBordSharePrefs.SHOPPINGCART)) {
                    StoryBordSharePrefs.getInstance(getContext()).putBoolean(StoryBordSharePrefs.SHOPPINGCART, true);
                }
                if (!StoryBordSharePrefs.getInstance(getContext()).getBoolean(StoryBordSharePrefs.SUBSUBCATEGORY)) {
                    StoryBordSharePrefs.getInstance(getContext()).putBoolean(StoryBordSharePrefs.SUBSUBCATEGORY, true);
                }
                if (!StoryBordSharePrefs.getInstance(getContext()).getBoolean(StoryBordSharePrefs.RETURNREPLACE)) {
                    StoryBordSharePrefs.getInstance(getContext()).putBoolean(StoryBordSharePrefs.RETURNREPLACE, true);
                }
                if (!StoryBordSharePrefs.getInstance(getContext()).getBoolean(StoryBordSharePrefs.RETURNORDER)) {
                    StoryBordSharePrefs.getInstance(getContext()).putBoolean(StoryBordSharePrefs.RETURNORDER, true);
                }
                if (!StoryBordSharePrefs.getInstance(getContext()).getBoolean(StoryBordSharePrefs.MYORDER)) {
                    StoryBordSharePrefs.getInstance(getContext()).putBoolean(StoryBordSharePrefs.MYORDER, true);
                }
                if (!StoryBordSharePrefs.getInstance(getContext()).getBoolean(StoryBordSharePrefs.PAYMENTOPTION)) {
                    StoryBordSharePrefs.getInstance(getContext()).putBoolean(StoryBordSharePrefs.PAYMENTOPTION, true);
                }
                if (!StoryBordSharePrefs.getInstance(getContext()).getBoolean(StoryBordSharePrefs.MYWALLET)) {
                    StoryBordSharePrefs.getInstance(getContext()).putBoolean(StoryBordSharePrefs.MYWALLET, true);
                }
            } else {
                switch (dismissType) {
                    case outside:
