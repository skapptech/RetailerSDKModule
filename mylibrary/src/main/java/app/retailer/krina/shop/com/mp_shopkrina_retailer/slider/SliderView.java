package app.retailer.krina.shop.com.mp_shopkrina_retailer.slider;

import static app.retailer.krina.shop.com.mp_shopkrina_retailer.slider.IndicatorView.draw.controller.AttributeController.getRtlMode;
...
import app.retailer.krina.shop.com.mp_shopkrina_retailer.slider.IndicatorView.PageIndicatorView;
import app.retailer.krina.shop.com.mp_shopkrina_retailer.slider.IndicatorView.animation.type.BaseAnimation;
...
import app.retailer.krina.shop.com.mp_shopkrina_retailer.slider.IndicatorView.draw.data.RtlMode;
import app.retailer.krina.shop.com.mp_shopkrina_retailer.slider.IndicatorView.utils.DensityUtils;
import app.retailer.krina.shop.com.mp_shopkrina_retailer.slider.InfiniteAdapter.InfinitePagerAdapter;
import app.retailer.krina.shop.com.mp_shopkrina_retailer.slider.Transformations.AntiClockSpinTransformation;
import app.retailer.krina.shop.com.mp_shopkrina_retailer.slider.Transformations.Clock_SpinTransformation;
import app.retailer.krina.shop.com.mp_shopkrina_retailer.slider.Transformations.CubeInDepthTransformation;
import app.retailer.krina.shop.com.mp_shopkrina_retailer.slider.Transformations.CubeInRotationTransformation;
import app.retailer.krina.shop.com.mp_shopkrina_retailer.slider.Transformations.CubeInScalingTransformation;
import app.retailer.krina.shop.com.mp_shopkrina_retailer.slider.Transformations.CubeOutDepthTransformation;
import app.retailer.krina.shop.com.mp_shopkrina_retailer.slider.Transformations.CubeOutRotationTransformation;
import app.retailer.krina.shop.com.mp_shopkrina_retailer.slider.Transformations.CubeOutScalingTransformation;
import app.retailer.krina.shop.com.mp_shopkrina_retailer.slider.Transformations.DepthTransformation;
import app.retailer.krina.shop.com.mp_shopkrina_retailer.slider.Transformations.FadeTransformation;
import app.retailer.krina.shop.com.mp_shopkrina_retailer.slider.Transformations.FanTransformation;
import app.retailer.krina.shop.com.mp_shopkrina_retailer.slider.Transformations.FidgetSpinTransformation;
import app.retailer.krina.shop.com.mp_shopkrina_retailer.slider.Transformations.GateTransformation;
import app.retailer.krina.shop.com.mp_shopkrina_retailer.slider.Transformations.HingeTransformation;
import app.retailer.krina.shop.com.mp_shopkrina_retailer.slider.Transformations.HorizontalFlipTransformation;
import app.retailer.krina.shop.com.mp_shopkrina_retailer.slider.Transformations.PopTransformation;
import app.retailer.krina.shop.com.mp_shopkrina_retailer.slider.Transformations.SimpleTransformation;
import app.retailer.krina.shop.com.mp_shopkrina_retailer.slider.Transformations.SpinnerTransformation;
import app.retailer.krina.shop.com.mp_shopkrina_retailer.slider.Transformations.TossTransformation;
import app.retailer.krina.shop.com.mp_shopkrina_retailer.slider.Transformations.VerticalFlipTransformation;
import app.retailer.krina.shop.com.mp_shopkrina_retailer.slider.Transformations.VerticalShutTransformation;
import app.retailer.krina.shop.com.mp_shopkrina_retailer.slider.Transformations.ZoomOutTransformation;
        ...
        if (adapterItemsCount > 1) {
            if (mAutoCycleDirection == AUTO_CYCLE_DIRECTION_BACK_AND_FORTH) {
                if (currentPosition % (adapterItemsCount - 1) == 0 &&
                        mPreviousPosition != getAdapterItemsCount() - 1 && mPreviousPosition != 0) {
