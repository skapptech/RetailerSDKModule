...
class HomeMenuChildAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (listDataChild[position] == RetailerSDKApp.getInstance().dbHelper.getString(R.string.myAccount)) {
            holder.mBinding.imgIcon.setImageResource(R.drawable.myaccountt)
        } else if (listDataChild[position] == RetailerSDKApp.getInstance().dbHelper.getString(R.string.txt_My_Udhaar)) {
            holder.mBinding.imgIcon.setImageResource(R.drawable.myudharr)
        } else if (listDataChild[position] == RetailerSDKApp.getInstance().dbHelper.getString(R.string.hishab_kitab_wudu)) {
            holder.mBinding.imgIcon.setImageResource(R.drawable.wuduu)
        } else if (listDataChild[position] == RetailerSDKApp.getInstance().dbHelper.getString(R.string.kisan_dan)) {
            holder.mBinding.imgIcon.setImageResource(R.drawable.kisandann)
        } else if (listDataChild[position] == RetailerSDKApp.getInstance().dbHelper.getString(R.string.title_activity_return_order)) {
            holder.mBinding.imgIcon.setImageResource(R.drawable.returnreplacee)
        } else if (listDataChild[position] == RetailerSDKApp.getInstance().dbHelper.getString(R.string.title_business_card)) {
            holder.mBinding.imgIcon.setImageResource(R.drawable.bussinesscard)
        } else if (listDataChild[position] == RetailerSDKApp.getInstance().dbHelper.getString(R.string.request_brand)) {
...
//            holder.mBinding.imgIcon.setImageResource(R.drawable.faydaa)
        } else if (listDataChild[position] == RetailerSDKApp.getInstance().dbHelper.getString(R.string.feedback)) {
            holder.mBinding.imgIcon.setImageResource(R.drawable.feedbackk)
        } else if (listDataChild[position] == RetailerSDKApp.getInstance().dbHelper.getString(R.string.contact_us)) {
        ...
        } else if (listDataChild[position] == RetailerSDKApp.getInstance().dbHelper.getString(R.string.setting)) {
            holder.mBinding.imgIcon.setImageResource(R.drawable.settingg)
        } else if (listDataChild[position] == RetailerSDKApp.getInstance().dbHelper.getString(R.string.call)) {
            holder.mBinding.imgIcon.setImageResource(R.drawable.ic_call_rounded)
        } else if (listDataChild[position] == RetailerSDKApp.getInstance().dbHelper.getString(R.string.Whatsapp)) {
            holder.mBinding.imgIcon.setImageResource(R.drawable.whatsapp)
        } else if (listDataChild[position] == RetailerSDKApp.getInstance().dbHelper.getString(R.string.share)) {
            holder.mBinding.imgIcon.setImageResource(R.drawable.sharee)
        } else if (listDataChild[position] == RetailerSDKApp.getInstance().dbHelper.getString(R.string.title_game)) {
            holder.mBinding.imgIcon.setImageResource(R.drawable.gamee)
        } else if (listDataChild[position] == RetailerSDKApp.getInstance().dbHelper.getString(R.string.txt_My_Favourite)) {
            holder.mBinding.imgIcon.setImageResource(R.drawable.myfav)
        } else if (listDataChild[position] == RetailerSDKApp.getInstance().dbHelper.getString(R.string.txt_My_Dream)) {
            holder.mBinding.imgIcon.setImageResource(R.drawable.mydream)
        } else if (listDataChild[position] == RetailerSDKApp.getInstance().dbHelper.getString(R.string.direct_udhar)) {
            holder.mBinding.imgIcon.setImageResource(R.drawable.ic_loan_icon)
        } else if (listDataChild[position] == RetailerSDKApp.getInstance().dbHelper.getString(R.string.v_atm)) {
    ...
    fun setData(position: Int, holder: ViewHolder) {
        if (listDataChild[position] == RetailerSDKApp.getInstance().dbHelper.getString(R.string.myAccount)) {
            RetailerSDKApp.getInstance().updateAnalytics("my_account_click")
            activity.startActivity(Intent(activity, MyAccountActivity::class.java))
        } else if (listDataChild[position] == RetailerSDKApp.getInstance().dbHelper.getString(R.string.txt_My_Udhaar)) {
            RetailerSDKApp.getInstance().updateAnalytics("my_udhaar_click")
            activity.startActivity(Intent(activity, MyUdharActivity::class.java))
        } else if (listDataChild[position] == RetailerSDKApp.getInstance().dbHelper.getString(R.string.kisan_dan)) {
            RetailerSDKApp.getInstance().updateAnalytics("kisaan_daan_click")
            activity.startActivity(Intent(activity, KissanDaanActivity::class.java))
        } else if (listDataChild[position] == RetailerSDKApp.getInstance().dbHelper.getString(R.string.title_activity_return_order)) {
            RetailerSDKApp.getInstance().updateAnalytics("return_replace_click")
            ...
            RetailerSDKApp.getInstance().updateAnalytics("business_card_click")
            activity.startActivity(Intent(activity, BusinessCardActivity::class.java))
        } else if (listDataChild[position] == RetailerSDKApp.getInstance().dbHelper.getString(R.string.request_brand)) {
            RetailerSDKApp.getInstance().updateAnalytics("request_brand_click")
...
//            }
            ...
            RetailerSDKApp.getInstance().updateAnalytics("feedback_click")
            ...
            RetailerSDKApp.getInstance().updateAnalytics("share_whatsApp_click")
            activity.shareOnWhatsApp(true)
        } else if (listDataChild[position] == RetailerSDKApp.getInstance().dbHelper.getString(R.string.share)) {
            RetailerSDKApp.getInstance().updateAnalytics("share_click")
            activity.shareOnWhatsApp(false)
        } else if (listDataChild[position] == RetailerSDKApp.getInstance().dbHelper.getString(R.string.title_game)) {
            RetailerSDKApp.getInstance().updateAnalytics("game_click")
            ...
            RetailerSDKApp.getInstance().updateAnalytics("v_atm_click")
