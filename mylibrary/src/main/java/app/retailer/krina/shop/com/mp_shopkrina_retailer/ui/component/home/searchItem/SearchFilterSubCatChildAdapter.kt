...
class SearchFilterSubCatChildAdapter(
    private val context: Context,
    private val subCatClicked: SubCatClicked
    ...
    override fun onBindViewHolder(vh: RecyclerView.ViewHolder, position: Int) {
        try {
            ...
            (vh as ViewHolder).mBinding.checkbox.text = model.subcategoryName
            if (model.isChecked) {
            ...
            mBinding.checkbox.setOnCheckedChangeListener { compoundButton: CompoundButton, b: Boolean ->
                try {
                    if (compoundButton.isChecked) {
                        ...
                        subCatClicked.onSubCatClicked(selectedPos)
                    } else {
                        selectedPos = adapterPosition
