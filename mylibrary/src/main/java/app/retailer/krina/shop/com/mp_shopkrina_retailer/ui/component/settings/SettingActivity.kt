        ...
        when (v.id) {
            ...
            R.id.ll_edtProfile -> {
                if (TextUtils.isNullOrEmpty(
                    ...
                    RetailerSDKApp.getInstance().updateAnalytics("edit_profile_click")
            ...
            R.id.ll_changePass -> if (SharePrefs.getInstance(applicationContext)
                ...
                RetailerSDKApp.getInstance().updateAnalytics("change_password_click")
                startActivity(
                    Intent(
                        applicationContext,
                ...
                RetailerSDKApp.getInstance().updateAnalytics("check_signup_click")
            ...
            R.id.ll_changelanguage -> {
                RetailerSDKApp.getInstance().updateAnalytics("change_language_click")
                startActivity(Intent(applicationContext, ChangeLanguageActivity::class.java))
                Utils.fadeTransaction(this)
            }

            R.id.ll_rateApp -> {
                RetailerSDKApp.getInstance().updateAnalytics("rate_app_click")
                startActivity(Intent(applicationContext, RateAppActivity::class.java))
                Utils.fadeTransaction(this)
            }

            R.id.ll_shopDetail -> {
                RetailerSDKApp.getInstance().updateAnalytics("shop_detail_click")
                startActivity(Intent(applicationContext, ShopDetailsActivity::class.java))
                Utils.fadeTransaction(this)
            }

            R.id.liTerms -> {
                RetailerSDKApp.getInstance().updateAnalytics("terms_condition_click")
                startActivity(
            ...
            R.id.ll_logout -> {
                RetailerSDKApp.getInstance().updateAnalytics("logout_click")
                AlertDialog.Builder(this)
                    .setTitle(RetailerSDKApp.getInstance().dbHelper.getString(R.string.logout))
                    .setMessage(RetailerSDKApp.getInstance().dbHelper.getString(R.string.are_you_want_to_log_out))
                    .setPositiveButton(
                        RetailerSDKApp.getInstance().dbHelper.getString(R.string.yes_title)
...
//        }
    ...
    private fun initView() {
        ...
        mBinding!!.tvEditProfile.text =
            RetailerSDKApp.getInstance().dbHelper.getString(R.string.edit_profile)
        mBinding!!.tvChangePassword.text =
            RetailerSDKApp.getInstance().dbHelper.getString(R.string.changepassword)
        mBinding!!.tvRegionalHead.text =
            RetailerSDKApp.getInstance().dbHelper.getString(R.string.regional)
        ...
        mBinding!!.tvLogout.text = RetailerSDKApp.getInstance().dbHelper.getString(R.string.logout)
