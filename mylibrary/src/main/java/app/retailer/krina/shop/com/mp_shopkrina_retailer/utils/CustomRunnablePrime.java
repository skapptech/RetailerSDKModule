...
public class CustomRunnablePrime implements Runnable {
    ...
    public CustomRunnablePrime(Handler handler, TextView holder, long millisUntilFinished, int itemId, boolean isPrimeCustomer) {
    ...
    public CustomRunnablePrime(Handler handler, TextView holder, long millisUntilFinished) {
        this.handler = handler;
        this.holder = holder;
        this.millisUntilFinished = millisUntilFinished;
    }
        ...
        if (millisUntilFinished > 0) {
            ...
            if (itemId != 0) {
                if (isPrimeCustomer) {
                    ...
                    //  llPrimeTime.setVisibility(View.GONE);
                    holder.setText("Started");
                }
            }
        }
    }
